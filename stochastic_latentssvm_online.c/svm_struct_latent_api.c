...
//        "export LD_LIBRARY_PATH=~/lsvm_code/libs/lp_solve/:~/lsvm_code/libs/mosek.5/5/tools/platform/linux64x86/bin/ && "
        "export LD_LIBRARY_PATH=/usr/lib/lp_solve/:/home/apoorv/MTP/latentSVM_codesetup/mosek/5/tools/platform/linux64x86/bin/ && "
           " java -Xmx8G -cp java/bin:java/lib/* "
	   //" -Djava.library.path=../../libs/x86-64_sles10_4.1/:../../libs/lp_solve "
        " -Djava.library.path=/home/apoorv/MTP/DownloadDirector/installer/cplex/bin/x86-64_sles10_4.1/:/usr/lib/lp_solve "
	   " javaHelpers.FindMaxViolatorHelperAll ");
...
//			" -Djava.library.path='/home/ajay/Research/software/lp_solve/:/home/ajay/Research/software/mosek.5/5/tools/platform/linux64x86/bin/:/home/ajay/Research/software/x86-64_sles10_4.1/' "
			" -Djava.library.path=/home/apoorv/MTP/DownloadDirector/installer/cplex/bin/x86-64_sles10_4.1/:/usr/lib/lp_solve:/home/apoorv/MTP/latentSVM_codesetup/mosek/5/tools/platform/linux64x86/bin/ "
			" javaHelpers.FindMaxViolatorHelperAll ");
	strcat(cmd,filename);
	strcat(cmd, " ");
	strcat(cmd, trainfile);
...
//			"&& java -Xmx8G -cp java/bin:java/lib/* javaHelpers.InferLatentVarHelperAll ");
	strcpy(cmd,"export LD_LIBRARY_PATH=/usr/lib/lp_solve/:/home/apoorv/MTP/latentSVM_codesetup/mosek/5/tools/platform/linux64x86/bin/ "
				"&& java -Xmx8G -cp java/bin:java/lib/* javaHelpers.InferLatentVarHelperAll ");
